...
namespace Refatorando2
{
    ...
    {
        public static void TesteSubstituirArrayPorObjeto()
        {
            using(var streamReader = File.OpenText("clientes.csv"))
            {
                ...
                while ((linha =  streamReader.ReadLine()) != null)
                {
                    ...
                    Client cliente = new Client(int.Parse(campos[0]), campos[1], campos[2], campos[3]);
    ...
    class Client
    {
        ...
        public Client(int id, string nome, string telefone, string website)
        {
            this.id = id;
            this.nome = nome;
